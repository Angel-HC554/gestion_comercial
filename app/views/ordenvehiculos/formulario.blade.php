<div class="mx-10 shadow-lg rounded-lg p-8 mt-5 bg-white border border-zinc-200"
    ...
    <form id="ordenForm" @submit.prevent="submitForm">
            ...
            <div class="space-y-4 flex justify-evenly">
                <div x-data="{ checked: {{ (isset($ordenEditar) && $ordenEditar->orden_500 != 'NO') ? 'true' : 'false' }} }">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <div class="w-11 h-6 rounded-full transition-colors duration-200 ease-in-out focus:outline-none ring-offset-2 focus:ring-2 focus:ring-emerald-300" :class="checked ? 'bg-emerald-600' : 'bg-zinc-200'">
                            <div class="bg-white border border-gray-300 rounded-full h-5 w-5 shadow transition-transform duration-200 ease-in-out mt-[2px] ml-[2px]" :class="checked ? 'translate-x-5 border-transparent' : 'translate-x-0'"></div>
                        </div>
                ...
                <div x-data="{ checked: {{ (isset($ordenEditar) && $ordenEditar->requiere_servicio) ? 'true' : 'false' }} }">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <input type="checkbox" name="requiere_servicio" value="1" class="sr-only" x-model="checked">
        ...
        <div class="flex justify-center pb-8">
            <button type="submit" class="w-72 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-4 rounded-lg shadow-md transition-transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed" :disabled="loading">
                <span x-show="!loading">{{ isset($ordenEditar) ? 'ACTUALIZAR DOCUMENTO' : 'GENERAR DOCUMENTO' }}</span>
