...
<div class="mx-auto py-6" x-data="ordenesTable('{{ $noEconomico }}')" x-init="fetchData()" x-cloak>
    @csrf
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-zinc-200 text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">No. Orden
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">No. Eco
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Agencia
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Fecha</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">500</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Opciones
                        </th>
                    </tr>
                </thead>
                    ...
                    <template x-for="orden in ordenes" :key="orden.id">
                        <tr class="hover:bg-zinc-50/80 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <a href="#"
                                    class="text-zinc-500 font-medium decoration-zinc-400"
                                    x-text="orden.id"></a>
                            </td>

                            <td class="px-6 py-4 whitespace-nowrap text-zinc-600 font-medium"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex gap-2">
                                <button @click="openModal('more', orden)"
                                    class="shadow-xs cursor-pointer border border-gray-200 bg-gray-50 text-gray-700 p-1.5 rounded-md hover:bg-emerald-100 hover:text-emerald-700 transition duration-200">
                                ...
                                <a :href="'/ordenvehiculos/' + orden.id + '/edit'"
                                    class="shadow-xs border border-gray-200 text-gray-700 bg-gray-50 p-1.5 rounded-md hover:bg-indigo-100 hover:text-indigo-600 transition duration-200">
                                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <button @click="openModal('delete', orden)"
                                    class="shadow-xs cursor-pointer border border-gray-200 text-gray-700 bg-gray-50 p-1.5 rounded-md hover:bg-red-100 hover:text-red-600 transition duration-200">
                                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
